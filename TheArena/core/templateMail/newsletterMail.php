<?php require "headerMail.php" ?>
    <div class="div-container">
        <div class="row">
            <p>Bienvenue sur The Arena,<br> Cet e-mail a été créé car une nouvelle connexion au compte pseudo a été établie le 19 septembre 2022 04:03:00 PDT (19 septembre 2022 11:03:00 UTC) depuis :<br>
            <li>
                <ul>Lieu : <br></ul>
                <ul>appareil : <br></ul>
                <ul>Navigateur : <br></ul>
