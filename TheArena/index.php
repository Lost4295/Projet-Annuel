...
$routes = [
    ...
    "chat_chat" => $_SERVER['DOCUMENT_ROOT']."/wiews/chat/chat",
    ...
    "event_shop_create_shop" => $_SERVER['DOCUMENT_ROOT']."/wiews/events/shopper",
    ...
    "event_room_create" => $_SERVER['DOCUMENT_ROOT']."/wiews/events/createroomform",
    ...
    "user_interact_friend" => $_SERVER['DOCUMENT_ROOT']."/wiews/user/interact/friend",
    "user_interact_like" => $_SERVER['DOCUMENT_ROOT']."/wiews/user/interact/like",
    "user_interact_block" => $_SERVER['DOCUMENT_ROOT']."/wiews/user/interact/block",
