...
$routes = [
    ...
    "/error" => $_SERVER['DOCUMENT_ROOT']."/wiews/important/errorpage",
    ...
    "/admin/forums/create" => $_SERVER['DOCUMENT_ROOT']."/wiews/admin/forums/create",
    "/admin/forums/status" => $_SERVER['DOCUMENT_ROOT']."/wiews/admin/forums/status",
    "/admin/forums/update" => $_SERVER['DOCUMENT_ROOT']."/wiews/admin/forums/update",
    "/admin/forums/delete" => $_SERVER['DOCUMENT_ROOT']."/wiews/admin/forums/delete",
    "/admin/forum/read" => $_SERVER['DOCUMENT_ROOT']."/wiews/admin/forums/read",
    "/admin/forums/read" => $_SERVER['DOCUMENT_ROOT']."/wiews/admin/forums/read",
    ...
    "/admin/shops/delete" => $_SERVER['DOCUMENT_ROOT']."/wiews/admin/events/shops/delete",
    ...
    "/admin/tournament/unregister"=> $_SERVER['DOCUMENT_ROOT']."/wiews/admin/events/tournaments/unregister",
];
