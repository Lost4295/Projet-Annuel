...
<div class="row">
    ...
    <div class="col m-2">
        <a href="admin_users" class="text-decoration-none">
            <div class="card" style="width: 18rem;">
                <div class="card-body">
    ...
    <div class="col m-2">
        <a href="admin_events" class="text-decoration-none">
            <div class="card" style="width: 18rem;">
                <div class="card-body">
    ...
    <div class="col m-2">
        <a href="admin_tournaments" class="text-decoration-none">
            <div class="card" style="width: 18rem;">
                <div class="card-body">
    ...
    <div class="col m-2">
        <a href="admin_signalements" class="text-decoration-none">
            <div class="card" style="width: 18rem;">
                <div class="card-body">
