                        ...
                        <form action="../core/verify2.php" method="post">
                            <div class=" row mt-5 mb-3 pr-5" >
                                <div class="col">
                                    ...
                                    <div class="invalid"> <?php session_start(); if(isset($_SESSION["errorfirstname"]))echo $_SESSION['errorfirstname'];?></div>
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <div class="invalid"> <?php if(isset($_SESSION["errorlastname"]))echo $_SESSION['errorlastname'];?></div>
                                </div>
                            </div>
                            <div class=" row mt-5 mb-3 pr-5" >
                                <div class="col">
                                    ...
                                    <div class="invalid"> <?php if(isset($_SESSION["errorbirthdate"]))echo $_SESSION['errorbirthdate'];?></div>
                                </div>
                                <div class="col">
                                    <input type="hidden" class="form-control">
                                </div>
                                <div class="col">
                                    ...
                                    <div class="invalid"> <?php if(isset($_SESSION["errorphonenumber"]))echo $_SESSION['errorphonenumber'];?></div>
                                </div>
                            </div>
                            <div class=" row mt-5 mb-3 pr-5" >
                                <div class="col">
                                    ...
                                    <div class="invalid"> <?php if(isset($_SESSION["erroraddress"]))echo $_SESSION['erroraddress'];?></div>
                                </div>
                            </div>
                            <div class=" row mt-5 mb-3 pr-5" >
                                <div class="col">
                                    ...
                                    <div class="invalid"> <?php if(isset($_SESSION["errorcp"]))echo $_SESSION['errorcp'];?></div>
                                </div>
                                <div class="col">
                                    <label for="city" class="form-label">Ville</label>
                                    <input type="text" class="form-control" id="city" name="city"  required placeholder="Paris">
                                    <div class="invalid"> <?php if(isset($_SESSION["errorcity"]))echo $_SESSION['errorcity'];?></div>
                                </div>
                                <div class="col">
                                    <label for="country" class="form-label">Pays</label>
                                    <input type="text" class="form-control" id="country" name="country"  required placeholder="France">
                                    <div class="invalid"> <?php if(isset($_SESSION["errorcountry"]))echo $_SESSION['errorcountry'];?></div>
                            </div>
