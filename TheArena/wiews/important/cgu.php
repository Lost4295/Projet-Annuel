...
<br/>
<br/>
<p>Les présentes conditions générales d'utilisation (dites &laquo; <strong>CGU</strong> &raquo;) ont pour objet l'encadrement juridique des modalités de mise à disposition du site et des services par les administrateurs du site The Arena et de définir les conditions d'accès et d'utilisation des services par &laquo; <strong>l'Utilisateur</strong> &raquo;.</p>
<p>Les présentes CGU sont accessibles sur le site à la rubrique &laquo;<strong>CGU</strong>&raquo;.</p>
<br/>
<p>Toute inscription ou utilisation du site implique l'acceptation sans aucune réserve ni restriction des présentes CGU par l'utilisateur. Lors de l'inscription sur le site via le Formulaire d'inscription, chaque utilisateur accepte expressément les présentes CGU en cochant la case précédant le texte suivant : &laquo; <span class="text-decoration-underline">Je reconnais avoir lu et compris les CGU et je les accepte</span> &raquo;.</p>
...
<p><a href= https://thearena.litecloud.fr> https://thearena.litecloud.fr</a>  se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes CGU.</p>
<br/>
...
<br/>
<p>L'hébergeur du site <a href= https://thearena.litecloud.fr> https://thearena.litecloud.fr</a> est la société OVH Cloud.</p>
<br/>
<h1>ARTICLE 2 : Accès au site</h1>
<br/>
<p>Le site <a href= https://thearena.litecloud.fr> https://thearena.litecloud.fr</a>  permet à l'Utilisateur un accès gratuit aux services suivants :</p>
<ul><li>Gestion d'événements esportifs en ligne,</li><li> Vente de produits,</li><li> Forum en ligne,</li><li> Pages et gestion d'e-réputation.</li></ul>
...
<p>Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du site ou serveur et sous réserve de toute interruption ou modification en cas de maintenance, n'engage pas la responsabilité de <a href= https://thearena.litecloud.fr>https://therarena.litecloud.fr</a>  Dans ces cas, l'Utilisateur accepte ainsi ne pas tenir rigueur à l'éditeur de toute interruption ou suspension de service, même sans préavis.</p>
...
<br/>
<p>Le site assure à l'Utilisateur une collecte et un traitement d'informations personnelles dans le respect de la vie privée conformément à la loi n&deg;78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés.</p>
...
<ul>
<li><p>par mail à l'adresse email <a class="text-black" href="mailto:postmaster@thearena.litecloud.fr">postmaster@thearena.litecloud.fr</a></p> </li>
<li><p>via un formulaire de contact ;</p> </li>
<li><p>via son espace personnel ;</p> </li>
</ul>
<br/>
...
<br/>
<p>Les sources des informations diffusées sur le site <a href= https://thearena.litecloud.fr> https://thearena.litecloud.fr</a> sont réputées fiables mais le site ne garantit pas qu'il soit exempt de défauts, d'erreurs ou d'omissions.</p>
<p>Les informations communiquées sont présentées à titre indicatif et général sans valeur contractuelle. Malgré des mises à jour régulières, le site <a href= https://thearena.litecloud.fr> https://thearena.litecloud.fr</a> ne peut être tenu responsable de la modification des dispositions administratives et juridiques survenant après la publication. De même, le site ne peut être tenu responsable de l'utilisation et de l'interprétation de l'information contenue dans ce site.</p>
...
<p>Le site <a href= https://thearena.litecloud.fr> https://thearena.litecloud.fr</a> ne peut être tenu pour responsable d'éventuels virus qui pourraient infecter l'ordinateur ou tout matériel informatique de l'Internaute, suite à une utilisation, à l'accès, ou au téléchargement provenant de ce site.</p>
...
<br/>
<p>Des liens hypertextes peuvent être présents sur le site. L'Utilisateur est informé qu'en cliquant sur ces liens, il sortira du site <a href= https://thearena.litecloud.fr>.https://therarena.litecloud.fr</a>  Ce dernier n'a pas de contrôle sur les pages web sur lesquelles aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.</p>
<br/>
...
<p>Les cookies sont de petits fichiers stockés temporairement sur le disque dur de l'ordinateur de l'Utilisateur par votre navigateur et qui sont nécessaires à l'utilisation du site <a href= https://thearena.litecloud.fr>https://therarena.litecloud.fr</a>  Les cookies ne contiennent pas d'information personnelle et ne peuvent pas être utilisés pour identifier quelqu'un. Un cookie contient un identifiant unique, généré aléatoirement et donc anonyme. Certains cookies expirent à la fin de la visite de l'Utilisateur, d'autres restent.</p>
<p>L'information contenue dans les cookies est utilisée pour améliorer le site.</p>
