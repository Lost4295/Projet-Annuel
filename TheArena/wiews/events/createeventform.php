...
<div class="form-check">
  ...
  <div class="form-text" id="basic-addon1">Si l'événement est gratuit, tous les tournois le seront. Si l'événement est payant, tous les tournois ne le sont pas forcément.</div>
</div>
...
<input class="form-control mb-5" list="datalistOptions" id="exampleDataList" placeholder="Entrez le nom du jeu...">
