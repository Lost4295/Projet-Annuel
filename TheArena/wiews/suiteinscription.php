                        ...
                        <form>
                            ...
                            <div class=" row mt-5 mb-3 pr-5" >
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="75012">
                                </div>
                                <div class="col">
                                    <label for="exampleFormControlInput1" class="form-label">Ville</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Paris">
                                </div>
                                <div class="col">
                                    <label for="exampleFormControlInput1" class="form-label">Pays</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="France">
                                </div>
                            </div>
                            <div class="col-12">
